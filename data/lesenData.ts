export const lesenData = {
  teil1: {
    ubung1: {
      title: "Die Macht der inneren und äußeren Bilder",
      ...
      questions: [
        {
          text: "1. Klassische Fotoalben spielen heutzutage kaum noch eine Rolle.",
          options: [" Richtig", " Falsch"],
          answer: 0
        },
        {
          text: "2. Bilder – ob im Kopf oder digital – fördern unsere Vorstellungskraft.",
          options: [" Richtig", " Falsch"],
          answer: 0
        },
        {
          text: "3. Innere Bilder unterstützen uns dabei, unseren Alltag zu strukturieren.",
          options: [" Richtig", " Falsch"],
          answer: 0
        },
        {
          text: "4. Schockierende Bilder aus Kriegs- oder Unglückssituationen prägen sich automatisch ein.",
          options: [" Richtig", " Falsch"],
          answer: 0
        },
        {
          text: "5. Beim Lesen entsteht in unserer Fantasie eine Art persönliches Kopfkino.",
          options: [" Richtig", " Falsch"],
          answer: 0
        },
        {
          text: "6. Ein Bild kann, anders als Wörter, unterschiedlich interpretiert werden.",
          options: [" Richtig", " Falsch"],
          answer: 1
        }
      ]
